        ...
        "/api/v1/customers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort column (code, name, email, status, created_at, updated_at)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/reports/general-ledger": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by specific COA account UUID (optional)",
                        "name": "coa_id",
                        "in": "query"
                    }
                ],
