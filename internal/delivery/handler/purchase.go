...
func (h *PurchaseOrderHandler) FindAll(ctx *fiber.Ctx) error {
	...
	if totalCount == 0 || (qp.Page-1)*qp.PageSize >= totalCount {
		return ctx.Status(fiber.StatusOK).JSON(response.JSON{Status: fiber.StatusOK, Message: "No records found.", Data: []response.POResponse{}})
	}
...
func (h *PurchaseOrderHandler) Send(ctx *fiber.Ctx) error {
	...
	return ctx.Status(fiber.StatusOK).JSON(response.JSON{Status: fiber.StatusOK, Message: "Purchase order sent."})
}
...
func (h *PurchaseOrderHandler) Decline(ctx *fiber.Ctx) error {
	...
	return ctx.Status(fiber.StatusOK).JSON(response.JSON{Status: fiber.StatusOK, Message: "Purchase order declined."})
}
...
func (h *BillHandler) CreateFromPO(ctx *fiber.Ctx) error {
	...
	return ctx.Status(fiber.StatusCreated).JSON(response.JSON{Status: fiber.StatusCreated, Message: "Bill created from purchase order.", Data: result})
}
...
func (h *BillHandler) FindAll(ctx *fiber.Ctx) error {
	...
	if totalCount == 0 || (qp.Page-1)*qp.PageSize >= totalCount {
		return ctx.Status(fiber.StatusOK).JSON(response.JSON{Status: fiber.StatusOK, Message: "No records found.", Data: []response.BillResponse{}})
	}
	baseURL := ctx.Protocol() + "://" + ctx.Hostname() + ctx.Path()
	meta := util.GenerateMeta(baseURL, qp, totalCount)
	return ctx.Status(fiber.StatusOK).JSON(response.JSON{Status: fiber.StatusOK, Message: "Successfully retrieved records.", Data: entities, Meta: &meta})
...
func (h *BillHandler) Confirm(ctx *fiber.Ctx) error {
	...
	return ctx.Status(fiber.StatusOK).JSON(response.JSON{Status: fiber.StatusOK, Message: "Bill confirmed. Expense journal created.", Data: result})
}
...
func (h *BillHandler) AddPayment(ctx *fiber.Ctx) error {
	...
	return ctx.Status(fiber.StatusOK).JSON(response.JSON{Status: fiber.StatusOK, Message: "Payment recorded.", Data: result})
}
...
func (h *BillHandler) Cancel(ctx *fiber.Ctx) error {
	...
	return ctx.Status(fiber.StatusOK).JSON(response.JSON{Status: fiber.StatusOK, Message: "Bill cancelled.", Data: result})
}
